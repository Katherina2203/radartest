...
use backend\models\RefsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\data\ActiveDataProvider;

use common\models\Refauth;
...
class RefsController extends Controller
{
    ...
    public function actionIndex()
    {
      ...
      /*  $query = Refs::find()->joinWith(['refauth', 'authors', 'types'])->orderBy('owner DESC'); //
    ...
    {
        $model = new Refs();
        $query = $model->getAuthors()->with(['refauth'])->orderBy('owner DESC');
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
        ]);
    ...
    public function actionCreate()
    {
     ...
     public function actionAddauthor($refid)
    {
        $model = new Refs();
